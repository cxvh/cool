    ...
    GetBackgroundSheet: function () {
      for (
        var a = [],
          b = 0,
          c = 0,
          e = Enjine.Resources.Images.background.width / 32,
          d = Enjine.Resources.Images.background.height / 32,
          b = 0;
        b < e;
        b++
      ) {
    ...
    GetLevelSheet: function () {
      for (
        var a = [],
          b = 0,
          c = 0,
          e = Enjine.Resources.Images.map.width / 16,
          d = Enjine.Resources.Images.map.height / 16,
          b = 0;
        b < e;
        b++
      ) {
...
Mario.Character.prototype.GetFlower = function () {
  if (!(this.DeathTime > 0 && this.World.Paused))
    this.Fire
      ? (this.GetCoin(), Enjine.Resources.PlaySound("coin"))
      : ((this.World.Paused = !0),
        (this.PowerUpTime = 18),
...
Mario.Character.prototype.Kick = function (a) {
  if (!(this.DeathTime > 0 && this.World.Paused))
    Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A)
      ? ((this.Carried = a), (a.Carried = !0))
      : (Enjine.Resources.PlaySound("kick"), (this.InvulnerableTime = 1));
};
...
Mario.MapState.prototype.NextWorld = function () {
  ...
  if (this.WorldNumber !== 8) {
    for (
      this.YFarthestCap = this.XFarthestCap = this.Farthest = this.LevelId = this.MoveTime = 0;
      !a;
...
Mario.MapState.prototype.RenderStatic = function () {
  for (
    var a = 0,
      ...
      g = (c = 0),
      h = 0,
      i = Enjine.Resources.Images.worldMap,
      a = (g = 0);
    a < 20;
    a++
  )
